...
function AlertDialogContent({
  ...
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      <div className={cn("relative top-[50%] left-[50%] z-50 translate-x-[-50%] translate-y-[-50%]", className)}>
...
function AlertDialogFooter({
  ...
  return <ShadcnAlertDialogFooter className={cn("flex flex-col-reverse sm:flex-row gap-4", className)} {...props} />;
}
